...
- 完了: Phase 0.1〜0.4, 0.5.2/0.5.3, 仕様改訂, 2.0〜2.7, 1.1〜1.4, 3.1〜3.7（Phase 3 完了）, 4.1〜4.5, 5.1〜5.3（Phase 5 完了）, 6.1〜6.3
...
- 次の着手対象: **Phase 6.4（起動直後の対象選択）**。`<file>` 指定時はそのファイル、`<dir>` 指定時は `README.md` 検索、なければ空ペイン（`docs/preview.md` §9.1、`docs/plan.md` タスク 6.4）
