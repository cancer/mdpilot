...
- 完了: Phase 0.1〜0.4, 0.5.2/0.5.3, 仕様改訂, 2.0〜2.7, 1.1〜1.4, 3.1〜3.7（Phase 3 完了）, 4.1〜4.3
- 次の着手対象: **Phase 4.4（リンク挙動）**。外部 URL は OS 既定ブラウザ、相対 `.md` はプレビュー対象切替、その他は OS 既定アプリ。`egui_commonmark` のリンクフックを使う想定
