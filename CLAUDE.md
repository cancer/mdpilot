...
- 完了: Phase 0.1〜0.4, 0.5.2/0.5.3, 仕様改訂, 2.0〜2.7, 1.1〜1.4, 3.1〜3.7（Phase 3 完了）, 4.1〜4.5, 5.1〜5.3（Phase 5 完了）, 6.1〜6.5（Phase 6 完了）
...
- 次の着手対象: **Phase 7（UX 仕上げ）**。タスク多数（`Cmd+O` ダイアログ / キーバインド統合 / ウィンドウタイトル / メニューバー / パスバー / テーマ追従 / 性能測定）。`docs/plan.md` タスク 7.1 から順に
