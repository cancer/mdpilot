...
- 完了: Phase 0.1〜0.4, 0.5.2/0.5.3, 仕様改訂, 2.0〜2.7, 1.1〜1.4, 3.1〜3.7（Phase 3 完了）, 4.1〜4.5, 5.1
...
- 次の着手対象: **Phase 5.2（単一ファイル監視と再レンダリング・F-08）**。プレビュー対象 1 個を監視、100ms デバウンス、ファイル削除時の「見つかりません」表示。Phase 5.1 で組んだ `FileWatcher::start/watch/unwatch_all` を App に配線する
