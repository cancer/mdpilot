...
- 完了: Phase 0.1〜0.4, 0.5.2/0.5.3, 仕様改訂, 2.0〜2.7, 1.1〜1.4, 3.1〜3.7（Phase 3 完了）, 4.1〜4.5, 5.1〜5.3（Phase 5 完了）, 6.1〜6.5（Phase 6 完了）, 7.1〜7.4, 7.7〜7.9（Phase 7 完了、7.5/7.6 は 9.15/9.16 へ移送）, 9.1, 9.5, 9.17, 9.18 (F-11), 9.19 (履歴ピッカー)
...
- 次の着手対象: 未確定。残る Phase 9 項目（9.3 設定ファイル / 9.4 アプリメニュー / 9.6 数式・Mermaid・脚注 / 9.7 テーマ強制 / 9.8 tool_use 解釈 / 9.9 MCP / 9.10 安全モード / 9.11 プレビュー検索 / 9.12 チャット検索 / 9.13 ペイン比率永続化 / 9.15 macOS メニューバー / 9.16 Windows ツールバー）から再選択
