...
- 完了: Phase 0.1〜0.4, 0.5.2/0.5.3, 仕様改訂, 2.0〜2.7, 1.1〜1.4, 3.1〜3.7（Phase 3 完了）, 4.1〜4.5, 5.1〜5.3（Phase 5 完了）, 6.1〜6.4
...
- 次の着手対象: **Phase 6.5（`MDPILOT_PROJECT_ROOT` 環境変数の付与）**。claude 子プロセスに絶対パスを渡す（`docs/claude-integration.md` §3、`docs/plan.md` タスク 6.5）
