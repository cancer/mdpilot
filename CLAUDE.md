...
- 完了: Phase 0.1〜0.4, 0.5.2/0.5.3, 仕様改訂, 2.0〜2.7, 1.1〜1.4, 3.1〜3.7（Phase 3 完了）, 4.1〜4.5, 5.1〜5.3（Phase 5 完了）, 6.1〜6.5（Phase 6 完了）, 7.1
...
- 次の着手対象: **Phase 7.2（自動追従モード ON/OFF）**。`Cmd+O` で OFF、パスバーのボタンで再 ON（`docs/preview.md` §9.1.1、`docs/plan.md` タスク 7.2）
