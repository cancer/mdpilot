...
- 完了: Phase 0.1〜0.4, 0.5.2/0.5.3, 仕様改訂, 2.0〜2.7, 1.1〜1.4, 3.1〜3.7（Phase 3 完了）, 4.1
- 次の着手対象: **Phase 4.2（egui_commonmark 描画）**。`src/preview/render.rs` を作って `LoadedDocument` を egui に流し込む。同時に preview_pane.rs で空ペインと「ファイルが大きすぎます」エラー表示を統合
